...
if want linux-x86_64; then
    ...
    add container '{"platform":"linux-x86_64","artifact":"gnat-x86_64-linux","runner":"ubuntu-24.04","image":"debian:10","setup":"'"${deb10_setup}"'","label":"debian 10 (glibc 2.28)"}'
...
if want linux-aarch64; then
    ...
    add container '{"platform":"linux-aarch64","artifact":"gnat-aarch64-linux","runner":"ubuntu-24.04-arm","image":"debian:10","setup":"'"${deb10_setup}"'","label":"debian 10 arm64 (glibc 2.28)"}'
fi
